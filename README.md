...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/napari-tabu-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15238&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/napari-tabu-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `napari-tabu` can be installed with:

```
conda install napari-tabu
```

It is possible to list all of the versions of `napari-tabu` available on your platform with:
